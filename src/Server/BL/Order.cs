...
namespace JewelrySite.BL
{
	...
	public class Order
	{
		...
		[MaxLength(128)] public string? PaymentRef { get; set; }     // provider intent/id
                ...
                [MaxLength(64)] public string? PayPalOrderId { get; set; }
                [MaxLength(64)] public string? PayPalCaptureId { get; set; }
                [MaxLength(256)] public string? PayPalPayerEmail { get; set; }
                [Precision(18, 2)] public decimal? PayPalGrossAmount { get; set; }
                [Precision(18, 2)] public decimal? PayPalFeeAmount { get; set; }
                [Precision(18, 2)] public decimal? PayPalNetAmount { get; set; }
                public DateTime? PayPalCapturedAt { get; set; }
